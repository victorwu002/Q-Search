...
# dls xxx (DeepL 译至西)
DeepLtoespanol = type=http-request,pattern=^https:\/\/duckduckgo.com\/\?q=dls(\+|%20)([^&]+).+,script-path=https://raw.githubusercontent.com/victorwu002/Q-Search/main/DeepLQ-search.js
# dle xxx (DeepL 译至英)
